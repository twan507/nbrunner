...
def analyze_data(df, column_name=None):
    """
...
def save_analysis_to_excel(analysis_data, output_path):
    """
...
def merge_dataframes(df1, df2, on=None, how="outer"):
    """
    Kết hợp 2 DataFrame
...
def merge_excel_files(file1_path, file2_path, output_path, merge_on=None):
    """
